...
{
    internal class YellowRoar : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            for (int i = 0; i < flash.Count; i++)
            {
                ...
                Main.EntitySpriteDraw(flashTexture, flash[i].Item1 - Main.screenPosition, null, Color.Yellow * visibility, 0, flashTexture.Size() / 2, flash[i].Item2 / flashTexture.Width, SpriteEffects.None, 0);
